...
public class AdminController {
    ...
    public static void addEntrepriseOption() {
        String Name = view.getInput("Enter Entreprise's Name: ");
        String Password = view.getInput("Enter Entreprise's Password: ");

        if (model.addEntreprise(Name, Password)) {
            view.displayMessage("Entreprise added successfully.");
        } else {
            showError("Failed to add Entreprise. Please try again.");
        }
    }
