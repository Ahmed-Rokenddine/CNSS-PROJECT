...
public class BaseController {
    ...
    public void run() {
        ...
        }else if ("Entreprise".equalsIgnoreCase(roleChoice)) {
            EntrepriseLogin();
        }else if ("Employe".equalsIgnoreCase(roleChoice)) {
    ...
    private void EntrepriseLogin() {
        view.displayMessage("Entreprise Login");
        EntrepriseController controller = new EntrepriseController(connection);
        controller.run();
    }
